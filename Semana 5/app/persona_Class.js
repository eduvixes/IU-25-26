class persona extends Validations{
	...
	*/
	...
	createForm_DELETE(fila){
		...
		// modificar presentacion (en este caso concreto para fecha)
		var mifecha = new Date(fila.fechaNacimiento_persona);
		document.getElementById('fechaNacimiento_persona').value = mifecha.toLocaleDateString();

		// poner inactivos los campos correspondientes
		this.colocartodosreadonly();
	...
	cambiarformatoFecha(stringfecha){
		...
		var mifecha = new Date(stringfecha);
		var day = mifecha.getDate();
		if(day < 10){
		 day = '0'+day;
		}

		var month = mifecha.getMonth() + 1;
		if(month < 10){
		 month = '0'+month;
		}
